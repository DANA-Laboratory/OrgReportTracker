...
exports.addReportClass = function (/*basedb*/ db, data) {
    return new Promise((resolve, reject) => {
        ...
        p.then((owner_id)=>{
          exports.insert(db, data, [data.caption, data.duration, owner_id, data.caption_pitypes, data.weight_pitypes]).then(resolve);
        }).catch((err)=>{
...
exports.addVariableCat_2 = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      ...
      p.then((VariableCat_1_id)=>{
        exports.insert(db, data, [data.caption, data.code, VariableCat_1_id]).then(resolve);
      }).catch((err)=>{
...
exports.addVariableCat_3 = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      ...
      p.then((VariableCat_2_id)=>{
          exports.insert(db, data, [data.caption, data.code, VariableCat_2_id]).then(resolve);
      }).catch((err)=>{
...
exports.addReportClassVariable = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      ...
      Promise.all([p1, p2]).then(([variabledef_id, reportclass_id])=>{
          exports.insert(db, data, [reportclass_id, variabledef_id]).then(resolve);
      }).catch((err)=>{
