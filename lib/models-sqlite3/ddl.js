...
module.exports = `\
    ...
    CREATE TABLE tblReportClass (id INTEGER PRIMARY KEY, caption TEXT Not Null UNIQUE, duration TEXT, ${fkey('User', false, 'owner')}, caption_pitypes TEXT, weight_pitypes TEXT, attribute TEXT);\
    CREATE TABLE tblVariableCat_1 (id INTEGER PRIMARY KEY, caption TEXT Not Null UNIQUE, code TEXT Not Null, attribute TEXT);\
    CREATE TABLE tblVariableCat_2 (id INTEGER PRIMARY KEY, caption TEXT Not Null UNIQUE, code TEXT Not Null, ${fkey('VariableCat_1', false)}, attribute TEXT);\
    CREATE TABLE tblVariableCat_3 (id INTEGER PRIMARY KEY, caption TEXT Not Null UNIQUE, code TEXT Not Null, ${fkey('VariableCat_2', false)}, attribute TEXT);\
    CREATE TABLE tblVariableDef (id INTEGER PRIMARY KEY, unit TEXT Not Null, caption TEXT Not Null UNIQUE, code TEXT Not Null UNIQUE, ${fkey('User', false, 'provider')}, ${fkey('User', false, 'owner')}, ${fkey('User', false, 'reviewer')}, attribute TEXT);\
    CREATE TABLE tblReportClassVariable (id INTEGER PRIMARY KEY, ${fkey('ReportClass', true)}, ${fkey('VariableDef', true)}, ${fkey('VariableCat_3', false)}, weight DOUBLE);\
    ...
    CREATE TABLE tblVariable (id INTEGER PRIMARY KEY, unit TEXT Not Null, caption TEXT Not Null, code TEXT Not Null, ${fkey('User', true, 'provider')}, ${fkey('User', true, 'owner')}, ${fkey('User', true, 'reviewer')}, attribute TEXT);\
    CREATE TABLE tblReportVariable (id INTEGER PRIMARY KEY, ${fkey('Report', true)}, ${fkey('Variable', true)}, weight TEXT);\
    ...
    CREATE VIEW tblvVariableDef AS SELECT * FROM tblVariableDef LEFT OUTER JOIN tblReportClassVariable ON tblVariableDef.id = tblReportClassVariable.variabledef_id;`;
