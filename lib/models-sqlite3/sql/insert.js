...
/*
  All basic insert codes will come here.
  each function will inserts one new row into only one table and logs time, ip, account and value of user
  ...
  this properties are utility values
