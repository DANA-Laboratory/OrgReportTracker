...
exports.addUser = function (/*basedb*/ db, data) {
    return db.pRun(`INSERT INTO ${data._tbl} ${data._clms} ${values(data._clmc)};`, [data.account, bcrypt.hashSync(data.password), data.fname, data.lname, data.pcode, data.workunit, data.sysadmin]);
};
