...
const insertvalidverbs = {
  ...
  addVariableCat_1: ['tblVariableCat_1', 2, '(caption, code)'],
  addVariableCat_2: ['tblVariableCat_2', 3, '(caption, code, variablecat_1_id)'],
  addVariableCat_3: ['tblVariableCat_3', 3, '(caption, code, variablecat_2_id)'],
  addVariableDef: ['tblVariableDef', 3, '(unit, caption, code)'],
  addReportVariable: ['tblReportVariableClass', 2,'(reportclass_id, variabledef_id)'],
  ...
  setValue: ['tblPIValue', 5, '(pi_id, value, time_update, user_update, ip_user)'],
  setTarget: ['tblPITarget', 6, '(pi_id, value, time_target, time_update, user_update , ip_user)'],
...
const deletevalidverbs = {
  ...
  removeAllReportVariables: ['tblReportVariableClass'],
