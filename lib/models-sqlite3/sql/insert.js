...
exports.addPIType_2 = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      var p = (Number.isInteger(data.pitype_1_id)) ? Promise.resolve(data.pitype_1_id) : sqlSelect.idfordata(db, {_tbl:'tblPIType_1' , _where:'caption', caption:data.pitype_1_id});
      p.then((pitype_1_id)=>{
...
exports.addPIType_3 = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      var p = (Number.isInteger(data.pitype_2_id)) ? Promise.resolve(data.pitype_2_id) : sqlSelect.idfordata(db, {_tbl:'tblPIType_2' , _where:'caption', caption:data.pitype_2_id});
      p.then((pitype_2_id)=>{
...
exports.addReportVariable = function (/*basedb*/ db, data) {
  return new Promise((resolve, reject) => {
      ...
      Promise.all([p1, p2]).then(([variabledef_id, reportclass_id])=>{
        ...
        reject('addReportVariable() fails to fined related records with: ' + err);
      });
  });
};
