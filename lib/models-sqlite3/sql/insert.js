...
exports.addUser = function (db, data) {
    return validator.validateForInsert('tblUser', data)
...
exports.addReportClass = function (db, data) {
    return validator.validateForInsert('tblReportClass', data)
        .then(function (/*resData*/) {
...
exports.createReport = function (db, data) {
    return validator.validateForInsert('tblReport', data)
        .then(function (/*resData*/) {
...
exports.addAttachment = function (db, data) {
    return validator.validateForInsert('tblAttachment', data)
        .then(function (/*resData*/) {
...
exports.addPIType_1 = function (db, data) {
    return validator.validateForInsert('tblPIType_1', data)
        .then(function (/*resData*/) {
...
exports.addPIType_2 = function (db, data) {
    return validator.validateForInsert('tblPIType_2', data)
        .then(function (/*resData*/) {
...
exports.addPIType_3 = function (db, data) {
    return validator.validateForInsert('tblPIType_3', data)
        .then(function (/*resData*/) {
...
exports.addPIClass = function (db, data) {
    return validator.validateForInsert('tblPIClass', data)
        .then(function (/*resData*/) {
...
exports.createPI = function (db, data) {
    return validator.validateForInsert('tblPI', data)
        .then(function (/*resData*/) {
...
exports.setPIValue = function (db, data) {
    return validator.validateForInsert('tblPIValue', data)
        .then(function (/*resData*/) {
...
exports.setPITarget = function (db, data) {
    return validator.validateForInsert('tblPITarget', data)
        .then(function (/*resData*/) {
...
exports.sendMeggesge = function (db, data) {
    return validator.validateForInsert('tblMessage', data)
        .then(function (/*resData*/) {
