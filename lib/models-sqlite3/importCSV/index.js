...
exports.importUserFromCSV = function (/*basedb*/ db, path, transformFunction) {
    return new Promise(function (resolve, reject) {
        var counter = 0;
        db.exec("BEGIN");
        var csvParser = new (CSVParser)(function (err, userData, count) {
            if (!err) {
                insert.addUser(db, userData)
                    .then(function () {
                        counter += 1;
                        if (count === counter) {
                            db.exec("COMMIT");
...
/*
exports.importReportClassFromCSV
