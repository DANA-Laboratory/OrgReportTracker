const selectvalidator = {
  ...
  restfulGet: [
    ...
    'tblVariableCat_2', 'tblVariableCat_3', 'tblVariableDef', 'tblvVariableDef', 'tblReportClassVariable',
    'tblVariable', 'tblvValue', 'tblvVariable', 'tblvReportVariable', 'tblvReport', 'tblvTarget'
  ],
};
//select validator
