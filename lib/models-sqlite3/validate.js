...
const insertvalidverbs = {
  addUser: ['tblUser', 7, '(account, password, fname, lname, pcode, workunit, sysadmin)'],
  addReportClass: ['tblReportClass', 6, '(caption, duration, user_owner, caption_pitype_1, caption_pitype_2, caption_pitype_3)'],
  addPIType_1: ['tblPIType_1', 2, '(caption)'],
  addPIType_2: ['tblPIType_2', 3, '(caption, pitype_1_id)'],
  addPIType_3: ['tblPIType_3', 4, '(caption, pitype_2_id)'],
