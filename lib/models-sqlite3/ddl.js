...
module.exports = `\
    ...
    CREATE VIEW tblvValue AS SELECT tblValue.value, MAX(tblValue.time_update) time_update, tblValue.variable_id, MAX(tblValue.id) id, tblValue.attribute, tblValue.ip_user, tblValue.base FROM tblValue GROUP BY tblValue.variable_id;\
    CREATE VIEW tblvVariable AS SELECT tblVariable.*, tblvValue.id value_id, tblvValue.value, tblvValue.time_update, tblvValue.attribute value_attribute, tblvValue.ip_user, tblvValue.base FROM tblVariable LEFT OUTER JOIN tblvValue ON tblVariable.id = tblvValue.variable_id;\
    CREATE VIEW tblvReportVariable AS SELECT tblReportVariable.*, tblvVariable.value_id, tblvVariable.value, tblvVariable.time_update, tblvVariable.value_attribute, tblvVariable.ip_user, tblvVariable.base FROM tblReportVariable LEFT OUTER JOIN tblvVariable ON tblvVariable.id = tblReportVariable.variable_id;\
